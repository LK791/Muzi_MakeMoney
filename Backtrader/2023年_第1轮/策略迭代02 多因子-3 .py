...
#
#
# df = df[df['股票简称'].isin(所有股票名[:2]) ]

# df.to_hdf(
#     r'/Users/likai/Desktop/Python股票量化投资课程/00股票量化配套代码/xbx_stock_2019_完整代码/Backtrader/00 数据/2个_stock_2018.h5',
#     key='all_data',
#     mode='w'
# )
df = pd.read_hdf(
...
class celue001(bt.Strategy):
    ...
    def next(self):
        ...
        # 时间戳 = int(self.datas[0].datetime.date(0))
